public class Main {
    public static void main(String[] args) {
        ...
        */
        ...
        BoloChocolate boloAniversarioJoaninha = new BoloChocolate(30, true);

        boloAniversarioJoaninha.definirMensagem("Parabens algum nome");
        boloAniversarioJoaninha.setCorDecoracao("Castanho");
